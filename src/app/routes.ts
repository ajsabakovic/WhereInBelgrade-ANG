...
export const appRouter: Routes = [
    ...
    {path: 'events/favourites', component: LikedEventsComponent, runGuardsAndResolvers: 'always' ,resolve: {events: LikedEventsResolver}, canActivate: [AuthGuard]},
    {path: 'events/admin', component: AdminEventsComponent, runGuardsAndResolvers: 'always',  canActivate: [AuthGuard]},
    {path: 'events/:id', component: EventDetailsComponent},
    {path: 'events/new/insert', component: InsertEventComponent, runGuardsAndResolvers: 'always', resolve: {kategorije: InsertEventResolver, mesta: MestoInsertResolver}, canActivate: [AuthGuard]},
